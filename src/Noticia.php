...
final class Noticia {
    ...
    public function listarUm():array {
        ...
        if( $this->usuario->getTipo() === 'admin' ){
            ...
            de TODO MUNDO */
            $sql = "SELECT 
                    titulo, texto, resumo, imagem, categoria_id, usuario_id, destaque
                    FROM noticias WHERE id = :id";
        } else {
            
            $sql = "SELECT titulo, texto, resumo, imagem, categoria_id, usuario_id, destaque
    ...
    public function listarTodas():array {
        $sql = "SELECT data, titulo, imagem, resumo, id FROM noticias
         ORDER BY data DESC";
    ...
    public function listarDetalhes():array {
        $sql = "SELECT noticias.id, noticias.titulo, noticias.data, noticias.texto,
        noticias.imagem, usuarios.nome AS autor
        FROM noticias LEFT JOIN usuarios ON
    ...
    public function listarPorCategoria():array {
        $sql = "SELECT noticias.id, noticias.titulo, noticias.data, noticias.resumo,
         usuarios.nome AS autor, categorias.nome
         AS categoria
         FROM noticias
